...
public class JhipsterSamAppCucumberApp {

    private static final Logger log = LoggerFactory.getLogger(JhipsterSamAppCucumberApp.class);

    private final Environment env;

    public JhipsterSamAppCucumberApp(Environment env) {
        this.env = env;
    }

    /**
     * Initializes jhipsterSamAppCucumber.
     * <p>
    ...
    public static void main(String[] args) throws UnknownHostException {
        SpringApplication app = new SpringApplication(JhipsterSamAppCucumberApp.class);
